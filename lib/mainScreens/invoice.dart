  ...
  Future<void> _initSharedPreferences() async {
    ...
    if (uid != null) {
      final QuerySnapshot<Map<String, dynamic>> businessSnapshot = await FirebaseFirestore.instance
          ...
          .where('uid', isEqualTo: uid) // Use the correct field name for UID
          .get();
      ...
      if (businessSnapshot.docs.isNotEmpty) {
        ...
        setState(() {
          businessNameController.text = data['business_name'] ?? "No Name";
          businessLocationController.text = data['address'] ?? "No Address";
          businessPhoneController.text = data['phone'] ?? "No Phone";
